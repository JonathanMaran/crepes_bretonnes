...
SECRET_KEY = 'c8(74i29&0!d&3$=wpw%jnz0b4w6w6g7de-*y@5)asa#35*&=c'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# permet de renseigner les noms de domaine et adresses IP par lesquels le projet est accessible lorsque le mode DEBUG est désactivé
ALLOWED_HOSTS = []
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # Ajout de la fonction créée get_infos
